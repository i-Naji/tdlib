...
class Audio extends TdObject {
  ...
  Audio.fromJson(Map<String, dynamic> json)  {
    ...
    this.albumCoverMinithumbnail = Minithumbnail.fromJson(json['album_cover_minithumbnail'] ?? <String, dynamic>{});
    this.albumCoverThumbnail = Thumbnail.fromJson(json['album_cover_thumbnail'] ?? <String, dynamic>{});
