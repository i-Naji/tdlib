...
class LanguagePackStringValueOrdinary implements LanguagePackStringValue {
  String value;
  dynamic extra;
...
class LanguagePackStringValuePluralized implements LanguagePackStringValue {
  String zeroValue;
  String oneValue;
  String twoValue;
  String fewValue;
...
class LanguagePackStringValueDeleted implements LanguagePackStringValue {
  dynamic extra;
